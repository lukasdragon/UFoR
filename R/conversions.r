...
#
# @param carbon_emissions A numeric vector of carbon emissions in the units
# corresponding to the chosen gas type
# @param gas_type A character vector of gas types
# @return The corresponding carbon dioxide equivalent emissions
# @link https://ghgprotocol.org/sites/default/files/ghgp/Global-Warming
