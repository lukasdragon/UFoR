...
#'
#' @return A summary list containing the count of violations for species, genus, family, and overall.
#' @export
#'
#' @examples
#' \dontrun{
#' data(TreeTown_Data)
#' santamoursummary(TreeTown_Data$Species, TreeTown_Data$Genus, TreeTown_Data$Family, TreeTown_Data$Region)
#' }
